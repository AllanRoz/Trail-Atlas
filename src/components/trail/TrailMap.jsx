...
export default function TrailMap({ trails, className = 'h-full w-full' }) {
  ...
  return (
    <div className={className}>
      <MapContainer center={center} zoom={4} scrollWheelZoom={false} className="h-full w-full rounded-2xl">
        <TileLayer
